 ...
 */
@ConvertAsProperties(dtd = "-//Kinyarwanda//Paldo//EN",
autostore = false)
public final class KinyarwandaTopComponent extends TopComponent implements TableModelListener
{

    private static KinyarwandaTopComponent instance;
    /** path to the icon used by the component and its open action */
    static final String ICON_PATH = "Kinyarwanda/favicon.png";
    private static final String PREFERRED_ID = "KinyarwandaTopComponent";
    ...
    public KinyarwandaTopComponent()
    {
        initComponents();
        setName(NbBundle.getMessage(KinyarwandaTopComponent.class, "CTL_KinyarwandaTopComponent"));
        setToolTipText(NbBundle.getMessage(KinyarwandaTopComponent.class, "HINT_KinyarwandaTopComponent"));
    ...
    private void initComponents() {
        ...
        KinyarwandaExampleCheck = new javax.swing.JCheckBox();
        englishExampleCheck = new javax.swing.JCheckBox();
        KinyarwandaPluralCheck = new javax.swing.JCheckBox();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(enToSwButton, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.enToSwButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(swToEnButton, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.swToEnButton.text")); // NOI18N
        ...
        wordField.setText(org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.wordField.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(resetButton, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.resetButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(KinyarwandaExampleCheck, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.KinyarwandaExampleCheck.text")); // NOI18N
        KinyarwandaExampleCheck.setEnabled(false);
        KinyarwandaExampleCheck.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KinyarwandaExampleCheckActionPerformed(evt);
            }
        });

        org.openide.awt.Mnemonics.setLocalizedText(englishExampleCheck, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.englishExampleCheck.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(KinyarwandaPluralCheck, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.KinyarwandaPluralCheck.text")); // NOI18N
        KinyarwandaPluralCheck.setEnabled(false);
        KinyarwandaPluralCheck.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KinyarwandaPluralCheckActionPerformed(evt);
            }
        });

        org.openide.awt.Mnemonics.setLocalizedText(englishPluralCheck, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.englishPluralCheck.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(informationLabel, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.informationLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(wordlabel, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.wordlabel.text")); // NOI18N
            ...
            .addGroup(optionsPanelLayout.createSequentialGroup()
                ...
                .addGroup(optionsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(optionsPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(wordField, javax.swing.GroupLayout.DEFAULT_SIZE, 489, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, optionsPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(KinyarwandaPluralCheck)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(englishExampleCheck)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(KinyarwandaExampleCheck)))
                .addContainerGap())
        );
        ...
        syncButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Kinyarwanda/gtk-refresh24.png"))); // NOI18N
        syncButton.setMnemonic('R');
        org.openide.awt.Mnemonics.setLocalizedText(syncButton, org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.syncButton.text")); // NOI18N
        syncButton.setToolTipText(org.openide.util.NbBundle.getMessage(KinyarwandaTopComponent.class, "KinyarwandaTopComponent.syncButton.toolTipText")); // NOI18N
        ...
        topComponent1Layout.setHorizontalGroup(
            ...
            .addGroup(topComponent1Layout.createSequentialGroup()
                ...
                .addGroup(topComponent1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(resultsPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 821, Short.MAX_VALUE)
        ...
        topComponent1Layout.setVerticalGroup(
            ...
            .addGroup(topComponent1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(resultsPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 428, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void KinyarwandaExampleCheckActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_KinyarwandaExampleCheckActionPerformed
    {//GEN-HEADEREND:event_KinyarwandaExampleCheckActionPerformed
        displayTranslation();
}//GEN-LAST:event_KinyarwandaExampleCheckActionPerformed
    ...
    private void KinyarwandaPluralCheckActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_KinyarwandaPluralCheckActionPerformed
    {//GEN-HEADEREND:event_KinyarwandaPluralCheckActionPerformed
        displayTranslation();
}//GEN-LAST:event_KinyarwandaPluralCheckActionPerformed
    ...
    private javax.swing.JCheckBox KinyarwandaExampleCheck;
    private javax.swing.JCheckBox KinyarwandaPluralCheck;
     ...
     */
    public static synchronized KinyarwandaTopComponent getDefault()
    {
        if (instance == null)
        {
            instance = new KinyarwandaTopComponent();
        }
        return instance;
    }

    /**
     * Obtain the KinyarwandaTopComponent instance. Never call {@link #getDefault} directly!
     */
    public static synchronized KinyarwandaTopComponent findInstance()
    {
        TopComponent win = WindowManager.getDefault().findTopComponent(PREFERRED_ID);
        if (win == null)
        {
            Logger.getLogger(KinyarwandaTopComponent.class.getName()).warning(
                    "Cannot find " + PREFERRED_ID + " component. It will not be located properly in the window system.");
            return getDefault();
        }
        if (win instanceof KinyarwandaTopComponent)
        {
            return (KinyarwandaTopComponent) win;
        }
        Logger.getLogger(KinyarwandaTopComponent.class.getName()).warning(
    ...
    private void displayTranslation()
    {
        ...
        class TranslatorThread extends Thread
        {
            ...
            public void run()
            {
                ...
                String paldoLanguage = "Kinyarwanda";
                                    ...
                                    editEntry.addActionListener(new ActionListener()
                                    {
                                        ...
                                        public void actionPerformed(ActionEvent e)
                                        {
                                            ...
                                            NotifyDescriptor.InputLine question = new NotifyDescriptor.InputLine(
                                                    ...
                                                    NbBundle.getMessage(KinyarwandaTopComponent.class, "CTL_KinyarwandaTopComponent"),
...
//                                                    DialogDisplayer.getDefault().notify(d);
                ...
                resultsTable.putClientProperty("print.name", "Kamusi Desktop Kinyarwanda Dictionary search for " + word); // NOI18N
    ...
    private void reset()
    {
        EventQueue.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                ...
                KinyarwandaPluralCheck.setSelected(false);
                englishExampleCheck.setSelected(false);
                KinyarwandaExampleCheck.setSelected(false);
                resultsPanel.removeAll();
    ...
    private Vector<String> getDisplayableFields()
    {
        ...
        if (KinyarwandaPluralCheck.isSelected())
        {
            fields.add("Swahili Plural");
        }
        if (KinyarwandaExampleCheck.isSelected())
        {
